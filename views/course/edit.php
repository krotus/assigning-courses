...
<?php 
	$course = Course::getSelfFromDatabaseById($_GET["id"]);
?>
...
<form action="../../controllers/course/ctrlEditCourse.php" method="post">
	...
	<div class="form-group row">
	    ...
	    <div class="col-md-6">
	      	<input type="text" class="form-control" id="name" name="name" placeholder="Name" value="<?= $course->getName() ?>" required>
	    </div>
	</div>
	<div class="form-group row">
	    ...
	    <div class="col-md-2">
      		<?php 
	      		...
	      		$enterprise->loadDropdownlistThemes($course);
      		?>
	    </div>
	</div>
	<div class="form-group row">
	    ...
	    <div class="col-md-6">
	      	<input type="number" class="form-control" id="hours" name="hours" placeholder="Hours lasting" value="<?= $course->getHours() ?>" required>
	    </div>
	</div>
	<div class="form-group row">
	    <label for="start_date" class="col-md-2 form-control-label">Start Date</label>
	    <div class="col-md-2">
			<input type="text" class="form-control" name="start_date" id="start_date" value="<?= $course->getStartDate() ?>" required> 
	    </div>
	...
	<div class="form-group row">
	    <div class="col-md-offset-2 col-md-6" style="text-align:right;">
	    	...
	    	<script src="../../assets/js/alertCancel.js"></script>
	      	<button type="submit" class="btn btn-primary" name="btn_edit_course">Edit</button>
	    </div>
	</div>
	<?php 
